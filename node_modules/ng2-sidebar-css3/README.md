...
[![NPM](https://nodei.co/npm/ng2-sidebar-css3.png?compact=true)](https://nodei.co/npm/ng2-sidebar-css3/)
...
```shell
npm install --save ng2-sidebar-css3
```
...
var map = {
  // ...
  'ng2-sidebar': 'node_modules/ng2-sidebar-css3',
  // ...
};
